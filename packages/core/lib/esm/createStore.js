...
export default function (_a) {
    ...
    var rootReducer = combineReducers(rootReducerConfig);
    ...
    var rootSaga = function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, all(__spreadArray([], sagas, true))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    var store = createStore(rootReducer, composeEnhancers(applyMiddleware.apply(void 0, __spreadArray(__spreadArray([], middlewares, false), [sagaMiddleware], false))));
